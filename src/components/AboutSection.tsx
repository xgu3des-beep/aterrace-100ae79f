  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col justify-start overflow-hidden pt-20">
        ...
        <div className="w-full max-w-[90rem] mx-auto px-5 md:px-16 lg:px-20 pb-4 md:pb-6 border-b border-border/30 mb-6 md:mb-8 text-center">
          <span className="font-body text-[10px] md:text-xs tracking-[0.3em] uppercase text-gold mb-2 block">
            {t.space.label}
          </span>
        ...
        <div className="w-full max-w-[90rem] mx-auto px-5 md:px-16 lg:px-20 flex items-center gap-12 lg:gap-20 flex-1 min-h-0">
          ...
          <div className="flex-1 min-w-0 max-w-lg">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.span
                  ...
                  className="block text-4xl md:text-6xl mb-3 md:mb-5"
                >
                  {items[active].emoji}
                </motion.span>

                <h2 className="font-display text-3xl md:text-5xl lg:text-[3.5rem] font-bold text-foreground leading-[1.1] tracking-tight">
                  {items[active].title}
                </h2>

                <p className="font-body text-base md:text-xl mt-4 md:mt-6 text-muted-foreground leading-relaxed max-w-md">
            ...
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="font-body text-xs tracking-[0.3em] uppercase text-muted-foreground mt-8 md:mt-12 block"
              >
          ...
          {/* Mobile: stacked image at the bottom (decorative, behind content) */}
          <div className="lg:hidden absolute bottom-6 left-5 right-5 pointer-events-none">
            <AnimatePresence mode="wait">
              <motion.div
                key={`mobile-${active}`}
